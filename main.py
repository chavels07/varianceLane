...
if __name__ == '__main__':
    ...
    peak_pd = PlanDuration(PEAK_LANE_MOVEMENT_MAPPING, 16.5, 20)
    normal1_pd = PlanDuration(LANE_MOVEMENT_MAPPING, 0, 16.5)
    normal2_pd = PlanDuration(LANE_MOVEMENT_MAPPING, 20, 24)
    day_lane_plan = DayLanePlan([peak_pd, normal1_pd, normal2_pd])
